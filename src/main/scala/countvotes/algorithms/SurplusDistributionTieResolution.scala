...
// identical to ACTSurplusDistributionTieResolution
trait IACTSurplusDistributionTieResolution extends ISTVMethod[ACTBallot] with SurplusDistributionTieResolution{
