...
class BipartisanSetTest extends Specification {
  ...
  "BipartisanSet Test " should {
    ...
    "verify result" in { bipartisanSetVerification("37-example.e", "37-candidates.txt", "bipartisan-param.json") shouldEqual expectedBipartisanSet }
  ...
  def bipartisanSetVerification(electionFile: String, candidatesFile: String, paramFile: String): Set[Candidate] = {
    ...
    val param = MethodParamParser.parse("../Agora/files/Examples/" + paramFile)
