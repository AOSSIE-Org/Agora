...
import countvotes.methods.{Schulze}
import countvotes.parsers.{CandidatesParser, PreferencesParser, PreferencesParserWithRank}
import countvotes.structures.{Candidate, Election, Rational}
