...
class SinglePeakednessTest  extends Specification {
  ...
  "Single Peakedness Test " should {
    ...
    "verify result" in { singlePeakednessVerification("24-example.e", "24-candidates.txt") shouldEqual singlePeaked }
    "verify result" in { singlePeakednessVerification("25-example.e", "24-candidates.txt") shouldEqual notSinglePeaked }
    "verify result" in { singlePeakednessVerification("26-example.e", "24-candidates.txt") shouldEqual singlePeaked }
    "verify result" in { singlePeakednessVerification("27-example.e", "27-candidates.txt") shouldEqual notSinglePeaked }
