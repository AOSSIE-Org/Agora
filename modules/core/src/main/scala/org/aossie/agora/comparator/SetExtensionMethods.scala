...
/**
  ...
  * to extend the preferences that voters have over individual alternatives to (not necessarily
...
abstract class SetExtensionMethods[B <: Ballot] {
  ...
  def compare(election: org.aossie.agora.model.Election[Ballot], candidates: List[Candidate], parameters: Parameters): Set[Candidate]
