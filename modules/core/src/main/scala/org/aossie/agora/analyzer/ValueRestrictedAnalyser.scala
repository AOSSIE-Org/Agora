...
import org.aossie.agora.model.{Candidate, Election, PreferenceBallot => Ballot}
...
object ValueRestrictedAnalyser extends PreferenceAnalysisMethod[Ballot] {
  ...
  /**
    ...
    * @return
    */
  override def analyse(election: org.aossie.agora.model.Election[Ballot], ccandidates: List[Candidate]): Boolean = {
